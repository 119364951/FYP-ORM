...
# Derived from the video "Python Django Tutorial: Full-Featured Web App Part 2 - Applications and Routes" Timestamp 8:00
# Code derived and upgraded from "Python Django Tutorial: Full-Featured Web App Part 6 - User Registration" Timestamp: 14:35
# Code derived and upgraded from "Python Django Tutorial: Full-Featured Web App Part 7 - Login and Logout System" Timestamp: 2:13, 4:44, 24:00
# Code derived and upgraded from "Python Django Tutorial: Full-Featured Web App Part 12 - Email and Password Reset" Timestamp: 1:10, 4:10, 18:00
